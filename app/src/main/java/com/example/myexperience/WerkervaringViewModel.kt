...
class WerkervaringViewModel : ViewModel() {
    ...
    private var _ervaringen: MutableLiveData<List<WerkErvaring>> = MutableLiveData()
    val ervaringen: LiveData<List<WerkErvaring>>
        get() {
            return _ervaringen
        }

    private var _werkErvaring: MutableLiveData<WerkErvaring> = MutableLiveData()
    val werkErvaring: LiveData<WerkErvaring>
        get() {
            return _werkErvaring
        }
    ...
    fun clickWerkErvaring (werkErvaring: WerkErvaring) {
        _werkErvaring.value = werkErvaring
    }
